...
const cssVariablesResolver: CSSVariablesResolver = () => ({
  ...
  light: {
    ...
    // Blue accent
    '--ds-color-accent-blue-weak':      'var(--ds-color-theme-light-accentBlue-weak)',
    '--ds-color-accent-blue-mid':       'var(--ds-color-theme-light-accentBlue-mid)',
    '--ds-color-accent-blue-strong':    'var(--ds-color-theme-light-accentBlue-strong)',
    // Green accent
    '--ds-color-accent-green-weak':     'var(--ds-color-theme-light-accentGreen-weak)',
    '--ds-color-accent-green-mid':      'var(--ds-color-theme-light-accentGreen-mid)',
    '--ds-color-accent-green-strong':   'var(--ds-color-theme-light-accentGreen-strong)',
    // Magenta accent
    '--ds-color-accent-magenta-weak':   'var(--ds-color-theme-light-accentMagenta-weak)',
    '--ds-color-accent-magenta-mid':    'var(--ds-color-theme-light-accentMagenta-mid)',
    '--ds-color-accent-magenta-strong': 'var(--ds-color-theme-light-accentMagenta-strong)',
  ...
  dark: {
    ...
    '--ds-color-accent-blue-strong':    'var(--ds-color-theme-dark-accentBlue-strong)',
    // Green accent
    '--ds-color-accent-green-weak':     'var(--ds-color-theme-dark-accentGreen-weak)',
    '--ds-color-accent-green-mid':      'var(--ds-color-theme-dark-accentGreen-mid)',
    '--ds-color-accent-green-strong':   'var(--ds-color-theme-dark-accentGreen-strong)',
    // Magenta accent
    '--ds-color-accent-magenta-weak':   'var(--ds-color-theme-dark-accentMagenta-weak)',
    '--ds-color-accent-magenta-mid':    'var(--ds-color-theme-dark-accentMagenta-mid)',
    '--ds-color-accent-magenta-strong': 'var(--ds-color-theme-dark-accentMagenta-strong)',
    // Generic accent aliases → blue (interactive default)
