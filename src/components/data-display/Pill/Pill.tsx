...
export function Pill<T extends ElementType = "div">({
  ...
  return (
    <Box
      ...
      onMouseEnter={
        interactive || hoverIcon ? () => setHovered(true) : undefined
      }
      onMouseLeave={
        interactive || hoverIcon ? () => setHovered(false) : undefined
      }
      {...rest}
    >
      {children}
      ...
      {hoverIcon ? (
        <Box
          ...
          style={{
            ...
            overflow: "hidden",
            transition:
              "opacity 120ms ease, width 120ms ease, margin-left 120ms ease",
          }}
        >
          {hoverIcon}
        </Box>
